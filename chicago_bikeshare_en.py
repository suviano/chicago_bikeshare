...
for gender in column_to_list_lazy(data_list, -2):
    # gender = data_item[-2]
    if gender == "Female":
        female += 1
    elif gender == "Male":
...
# Should return a list with [count_male, counf_female]
#  (e.g., [10, 15] means 10 Males, 15 Females)
def count_gender(data_list):
    """
    count the number the male and female from the input
      Args:
          data_list: a list with the genders from the file
      Returns:
          return the count of male and female in the input
    """
    male = 0
    female = 0
    for gender in column_to_list_lazy(data_list, -2):
...
def most_popular_gender(data_list):
    """
    Verify and return the name of the most popular gender from the input
      Args:
          data_list: a list with the genders from the file.
      Returns:
          return the name of it or with the number it's Equal
    """
    answer = ""
...
def count_user_type(data_list):
    """
    Do the count of the user types
      Args:
          data_list: the data with a list of user types.
      Returns:
          return a list with first item the count of customers
          and the secound for the subscribers
    """
    subscriber = 0
    customer = 0
    for user_type in column_to_list_lazy(data_list, -3):
...
answer = "there are some users without data about the gender"
print("Answer:", answer)
...
input("Press Enter to continue...")
# TASK 10
# Gender is easy because usually only have a few options.
# How about start_stations? How many options does it have?
...
def count_items(column_list):
    """
      function to count different items in a list.
      Args:
          param1: The list of itens.
      Returns:
          List types and another with the count of them
    ...
    count_items = list(result.values())
